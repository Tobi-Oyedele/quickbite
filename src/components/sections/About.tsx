      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-6 -left-6 bg-orange-600 text-white p-6 rounded-xl shadow-xl max-w-xs hidden sm:block">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {values.map((value, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white p-6 sm:p-8 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
                >
                  <div className="bg-orange-100 w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center mb-4 sm:mb-6">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 sm:px-6 py-3 sm:py-4 rounded-full text-gray-900 focus:outline-none focus:ring-4 focus:ring-orange-300"
            />
            <button className="px-6 sm:px-8 py-3 sm:py-4 bg-white text-orange-600 rounded-full font-semibold hover:bg-orange-50 transition-colors shadow-lg">
              Subscribe
            </button>
          </div>
        </div>
